...
make install-gui                # after which `bi gui <file>` opens it
cargo test
cargo fmt --check
...
[docs/specs/find.md](specs/find.md).
...
[docs/specs/scopes.md](specs/scopes.md).
...
[docs/specs/boundaries.md](specs/boundaries.md).
...
than a pair; see [docs/specs/surround.md](specs/surround.md).
...
rather than a row index — see [docs/specs/motions.md](specs/motions.md).
...
takes one; see [docs/specs/ranges.md](specs/ranges.md). A range with no
...
[docs/specs/move-lines.md](specs/move-lines.md).
...
itself in insert mode. See [docs/specs/lsp.md](specs/lsp.md) and the
specs beside it.
...
visible. See [docs/specs/regions.md](specs/regions.md).
...
[docs/specs/complete.md](specs/complete.md). `Backspace`
...
`tests/gitignore_git.rs`. See [docs/specs/files.md](specs/files.md) and
[docs/specs/gitignore.md](specs/gitignore.md).
...
keybinding ran. See [docs/specs/cmdline-history.md](specs/cmdline-history.md).
...
[docs/specs/alternate.md](specs/alternate.md).
...
[docs/specs/case.md](specs/case.md).
...
any range. See [docs/specs/substitute.md](specs/substitute.md).
...
See [docs/specs/windows.md](specs/windows.md).
...
[docs/specs/tree.md](specs/tree.md).
...
See [docs/specs/number.md](specs/number.md), including why the option takes
...
when you mean it. See [docs/specs/options.md](specs/options.md).
...
[docs/specs/decorations.md](specs/decorations.md).
...
[docs/specs/open-in-split.md](specs/open-in-split.md)). `x` drops a row — a hit, or a heading with everything under it — which is
...
embedded. See [docs/specs/find-in-files.md](specs/find-in-files.md).
...
See [docs/specs/resize.md](specs/resize.md).
...
See [docs/specs/symbols.md](specs/symbols.md).
...
[docs/specs/git-signs.md](specs/git-signs.md).
...
[docs/specs/todo-comments.md](specs/todo-comments.md).
...
in the text. See [docs/specs/flash.md](specs/flash.md).
...
[docs/specs/colors.md](specs/colors.md).
...
[docs/specs/trim.md](specs/trim.md).
...
[docs/specs/editorconfig.md](specs/editorconfig.md).
...
char and its `line:col`. See [docs/specs/encoding.md](specs/encoding.md).
...
sibling rather than a rewrite. See [docs/specs/lib-split.md](specs/lib-split.md).
...
- ~~**The config language is undecided**~~ Decided and mostly built: TOML, in
  ...
  and is step 2 of [docs/specs/config.md](specs/config.md).
...
- ~~**The cursor lives on `Buffer`.**~~ Fixed: `Editor` owns a `Selections` set
  ...
  is several. See [docs/specs/selections.md](specs/selections.md).
- ~~**Every command works out for itself what a selection covers.**~~ Fixed:
  ...
  [docs/specs/regions.md](specs/regions.md).
...
The rest of [docs/specs/config.md](specs/config.md): the theme (step 2),
