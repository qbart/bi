; Crystal highlights.
;
; The crate ships this file and comments its HIGHLIGHTS_QUERY constant out, so
; like Julia's and templ's it is vendored, verbatim, from
; crystal-lang-tools/tree-sitter-crystal (MIT), queries/nvim/highlights.scm at
; 50ca9e6fcfb16a2cbcad59203cfd8ad650e25c49. See docs/specs/tree-sitter.md.
;
; Upstream: https://github.com/crystal-lang-tools/tree-sitter-crystal
