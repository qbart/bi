; Julia highlights.
;
; tree-sitter-julia ships this file in its package but does not export it — the
; crate has LANGUAGE and NODE_TYPES and no HIGHLIGHTS_QUERY — and `include_str!`
; cannot reach into a dependency. So it is vendored, verbatim, from
; tree-sitter-julia 0.23.1 (MIT). See docs/specs/tree-sitter.md.
;
; Upstream: https://github.com/tree-sitter/tree-sitter-julia
